...
namespace StreamingAccounts.API.Migrations
{
    ...
    [Migration("20230520164047_user-productRent")]
    partial class userproductRent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StreamingAccounts.Shared.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StreamingAccounts.Shared.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StreamingAccounts.Shared.Entities.ProductRent", b =>
                {
                    ...
                    b.HasOne("StreamingAccounts.Shared.Entities.User", "User")
                        .WithMany("ProductRents")
            ...
            modelBuilder.Entity("StreamingAccounts.Shared.Entities.User", b =>
                {
                    b.HasOne("StreamingAccounts.Shared.Entities.City", "City")
                        .WithMany("Users")
